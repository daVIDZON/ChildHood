     ...
     ?>
        ...
        <div class="specialists" id="specialists">
            <div class="container">
                <div class="title"><?php the_field('about_workers'); ?></div>
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img" src="<?php the_field('about_companyimg'); ?>" alt="наша команда">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="toys" id="toys">
            <div class="container">
                <h2 class="subtitle"><?php the_field('about_products'); ?></h2>                     
                ...
                <h2 class="subtitle"><?php the_field('about_products2'); ?></h2>
                <div class="toys__wrapper">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span><?php the_field('about_description1'); ?></span> <?php the_field('about_description2'); ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                <h1 class="title"><?php  the_field('about_history'); ?></h1>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                        <?php  the_field('about_title_descr'); ?>
                        </div>
                        <div class="aboutus__text">
                        <?php  the_field('about_desription_history'); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php  the_field('about_img_history'); ?>" alt="мир детства">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                        <img class="aboutus__img" src=" <?php  the_field('about_img_description_2'); ?>" alt="мир детства">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                        <?php  the_field('about_title_history_2'); ?>
                        </div>
                        <div class="aboutus__text">
                        <?php  the_field('about_descriptin_history_2'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                        <?php  the_field('about_title_history_3'); ?>
                        </div>
                        <div class="aboutus__text">
                        <?php  the_field('about_desription_history_3'); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src=" <?php  the_field('about_img_history_3'); ?>" alt="мир детства">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="contacts" id="contacts">  
            <h1 class="title">  <?php  the_field('about_title_location'); ?></h1>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined">
                        <?php  the_field('about_location_2'); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="title contacts__minititle"> <?php  the_field('about_contacts'); ?></div>
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:+797867834347"><?php  the_field('about_phonenumber_1'); ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:+797867834358"><?php  the_field('about_phonenumber_2'); ?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="contacts__mail">
                                Или напишите нам на почту
                                <a href="mailto:mirdetstva@gmail.com"><?php  the_field('about_mail_contacts'); ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
