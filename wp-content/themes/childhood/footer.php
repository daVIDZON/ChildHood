                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    <a href="tel:+797867834347"><?php  the_field('about_phonenumber'); ?></a>
                                    <a href="tel:+797867834358"><?php  the_field('about_phonenumber2'); ?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
                                <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="footer__contacts-logo">
                                <address><?php  the_field('about_location'); ?></address>
                            </div>
                        </div>
                    </div>
                </div>
